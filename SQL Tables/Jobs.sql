...
CREATE TABLE IF NOT EXISTS `Jobs` (
  ...
  `EmployerIdentificationNumber` int(11) NOT NULL,
...
INSERT INTO `Jobs` (`ID`, `EmployerIdentificationNumber`, `DatePosted`, `Title`, `Location`, `Description`, `QuestionList1`, `QuestionList2`) VALUES
